...
const (
	ProviderAPI_AddGrant_FullMethodName               = "/necode.storage.provider.ProviderAPI/AddGrant"
	ProviderAPI_CreateContainer_FullMethodName        = "/necode.storage.provider.ProviderAPI/CreateContainer"
	ProviderAPI_TouchFile_FullMethodName              = "/necode.storage.provider.ProviderAPI/TouchFile"
	ProviderAPI_Delete_FullMethodName                 = "/necode.storage.provider.ProviderAPI/Delete"
	ProviderAPI_DenyGrant_FullMethodName              = "/necode.storage.provider.ProviderAPI/DenyGrant"
	ProviderAPI_GetPath_FullMethodName                = "/necode.storage.provider.ProviderAPI/GetPath"
	ProviderAPI_GetQuota_FullMethodName               = "/necode.storage.provider.ProviderAPI/GetQuota"
	ProviderAPI_InitiateFileDownload_FullMethodName   = "/necode.storage.provider.ProviderAPI/InitiateFileDownload"
	ProviderAPI_InitiateFileUpload_FullMethodName     = "/necode.storage.provider.ProviderAPI/InitiateFileUpload"
	ProviderAPI_ListGrants_FullMethodName             = "/necode.storage.provider.ProviderAPI/ListGrants"
	ProviderAPI_ListContainerStream_FullMethodName    = "/necode.storage.provider.ProviderAPI/ListContainerStream"
	ProviderAPI_ListContainer_FullMethodName          = "/necode.storage.provider.ProviderAPI/ListContainer"
	ProviderAPI_ListFileVersions_FullMethodName       = "/necode.storage.provider.ProviderAPI/ListFileVersions"
	ProviderAPI_ListRecycleStream_FullMethodName      = "/necode.storage.provider.ProviderAPI/ListRecycleStream"
	ProviderAPI_ListRecycle_FullMethodName            = "/necode.storage.provider.ProviderAPI/ListRecycle"
	ProviderAPI_Move_FullMethodName                   = "/necode.storage.provider.ProviderAPI/Move"
	ProviderAPI_RemoveGrant_FullMethodName            = "/necode.storage.provider.ProviderAPI/RemoveGrant"
	ProviderAPI_PurgeRecycle_FullMethodName           = "/necode.storage.provider.ProviderAPI/PurgeRecycle"
	ProviderAPI_RestoreFileVersion_FullMethodName     = "/necode.storage.provider.ProviderAPI/RestoreFileVersion"
	ProviderAPI_RestoreRecycleItem_FullMethodName     = "/necode.storage.provider.ProviderAPI/RestoreRecycleItem"
	ProviderAPI_Stat_FullMethodName                   = "/necode.storage.provider.ProviderAPI/Stat"
	ProviderAPI_UpdateGrant_FullMethodName            = "/necode.storage.provider.ProviderAPI/UpdateGrant"
	ProviderAPI_CreateSymlink_FullMethodName          = "/necode.storage.provider.ProviderAPI/CreateSymlink"
	ProviderAPI_CreateReference_FullMethodName        = "/necode.storage.provider.ProviderAPI/CreateReference"
	ProviderAPI_SetArbitraryMetadata_FullMethodName   = "/necode.storage.provider.ProviderAPI/SetArbitraryMetadata"
	ProviderAPI_UnsetArbitraryMetadata_FullMethodName = "/necode.storage.provider.ProviderAPI/UnsetArbitraryMetadata"
	ProviderAPI_SetLock_FullMethodName                = "/necode.storage.provider.ProviderAPI/SetLock"
	ProviderAPI_GetLock_FullMethodName                = "/necode.storage.provider.ProviderAPI/GetLock"
	ProviderAPI_RefreshLock_FullMethodName            = "/necode.storage.provider.ProviderAPI/RefreshLock"
	ProviderAPI_Unlock_FullMethodName                 = "/necode.storage.provider.ProviderAPI/Unlock"
	ProviderAPI_CreateHome_FullMethodName             = "/necode.storage.provider.ProviderAPI/CreateHome"
	ProviderAPI_GetHome_FullMethodName                = "/necode.storage.provider.ProviderAPI/GetHome"
	ProviderAPI_CreateStorageSpace_FullMethodName     = "/necode.storage.provider.ProviderAPI/CreateStorageSpace"
	ProviderAPI_ListStorageSpaces_FullMethodName      = "/necode.storage.provider.ProviderAPI/ListStorageSpaces"
	ProviderAPI_UpdateStorageSpace_FullMethodName     = "/necode.storage.provider.ProviderAPI/UpdateStorageSpace"
	ProviderAPI_DeleteStorageSpace_FullMethodName     = "/necode.storage.provider.ProviderAPI/DeleteStorageSpace"
)
...
type ProviderAPIClient interface {
	...
	// Arbitrary metadata is returned in a necode.storageprovider.ResourceInfo.
...
var ProviderAPI_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "necode.storage.provider.ProviderAPI",
	...
	Metadata: "necode/storage/provider/provider_api.proto",
}
