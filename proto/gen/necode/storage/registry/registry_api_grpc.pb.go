...
const (
	RegistryAPI_GetStorageProviders_FullMethodName  = "/necode.storage.registry.RegistryAPI/GetStorageProviders"
	RegistryAPI_ListStorageProviders_FullMethodName = "/necode.storage.registry.RegistryAPI/ListStorageProviders"
	RegistryAPI_GetHome_FullMethodName              = "/necode.storage.registry.RegistryAPI/GetHome"
)
...
var RegistryAPI_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "necode.storage.registry.RegistryAPI",
	...
	Metadata: "necode/storage/registry/registry_api.proto",
}
