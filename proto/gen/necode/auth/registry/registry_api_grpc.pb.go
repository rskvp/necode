...
const (
	RegistryAPI_GetAuthProviders_FullMethodName  = "/necode.auth.registry.RegistryAPI/GetAuthProviders"
	RegistryAPI_ListAuthProviders_FullMethodName = "/necode.auth.registry.RegistryAPI/ListAuthProviders"
)
...
var RegistryAPI_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "necode.auth.registry.RegistryAPI",
	...
	Metadata: "necode/auth/registry/registry_api.proto",
}
