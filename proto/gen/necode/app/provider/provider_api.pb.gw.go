...
func request_ProviderAPI_OpenInApp_0(ctx context.Context, marshaler runtime.Marshaler, client ProviderAPIClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_ProviderAPI_OpenInApp_0(ctx context.Context, marshaler runtime.Marshaler, server ProviderAPIServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq OpenInAppRequest
	var metadata runtime.ServerMetadata
...
func RegisterProviderAPIHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProviderAPIServer) error {
	...
	mux.Handle("POST", pattern_ProviderAPI_OpenInApp_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/necode.app.provider.ProviderAPI/OpenInApp", runtime.WithHTTPPathPattern("/necode.app.provider.ProviderAPI/OpenInApp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_ProviderAPI_OpenInApp_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_ProviderAPI_OpenInApp_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterProviderAPIHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProviderAPIClient) error {
	...
	mux.Handle("POST", pattern_ProviderAPI_OpenInApp_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/necode.app.provider.ProviderAPI/OpenInApp", runtime.WithHTTPPathPattern("/necode.app.provider.ProviderAPI/OpenInApp"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_ProviderAPI_OpenInApp_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_ProviderAPI_OpenInApp_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"necode.app.provider.ProviderAPI", "OpenInApp"}, ""))
)

var (
	forward_ProviderAPI_OpenInApp_0 = runtime.ForwardResponseMessage
)
